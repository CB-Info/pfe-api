...
describe('DishController', () => {
  ...
  describe('getTop20Ingredients', () => {
    ...
    it('should handle service errors', async () => {
      mockDishService.findTop20Ingredients.mockRejectedValue(new Error('Service error'));

      await expect(controller.getTop20Ingredients()).rejects.toThrow('Service error');
    });
  });
  ...
  describe('createOne', () => {
    ...
    it('should handle creation errors', async () => {
      ...
      await expect(controller.createOne(dishDto)).rejects.toThrow('Creation failed');
    });
  });
  ...
  describe('findOne', () => {
    ...
    it('should handle not found errors', async () => {
      ...
      await expect(controller.findOne({ id: 'nonexistent' })).rejects.toThrow('Dish not found');
    });
  });
  ...
  describe('updateOne', () => {
    ...
    it('should handle update errors', async () => {
      ...
      await expect(controller.updateOne({ id: 'dish123' }, updateData)).rejects.toThrow('Update failed');
    });
  });
  ...
  describe('deleteOne', () => {
    ...
    it('should handle deletion errors', async () => {
      ...
      await expect(controller.deleteOne({ id: 'dish123' })).rejects.toThrow('Deletion failed');
    });
  });
