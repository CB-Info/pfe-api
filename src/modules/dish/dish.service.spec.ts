...
describe('DishService', () => {
  ...
  describe('createOne', () => {
    ...
    it('should create a dish successfully', async () => {
      ...
      mockDishRepository.insert.mockResolvedValue({ _id: 'dish123' });
    ...
    it('should handle dish with multiple ingredients', async () => {
      ...
      const createdDish = { ...mockDish, ...multiIngredientDto, _id: 'dish123' };
      mockDishRepository.insert.mockResolvedValue({ _id: 'dish123' });
      mockDishRepository.findOneById.mockResolvedValue(createdDish);
  ...
  describe('Edge cases and error handling', () => {
    it('should handle empty string ID', async () => {
      // Empty string should still call the repository, which returns null
      mockDishRepository.findOneById.mockResolvedValue(null);
